...
angledWaterCraftFrame = {
    "facing=north,shape=straight": {
        "model": "alekiships:block/watercraft_frame_angled/straight",
        "y": 180
    },
    ...
    "facing=north,shape=inner_left": {
        "model": "alekiships:block/watercraft_frame_angled/inner",
        "y": 90
    },
    ...
    "facing=north,shape=outer_left": {
        "model": "alekiships:block/watercraft_frame_angled/outer",
        "y": 270
    },
...
def getWoodFrameMultipart(wood: str) -> list[Json]:
    ...
    json = [
        ({"facing": "north", "shape": "straight"},
         {"model": "alekiships:block/watercraft_frame_angled/straight", "y": 180}),
        ({"facing": "east", "shape": "straight"},
         {"model": "alekiships:block/watercraft_frame_angled/straight", "y": 270}),
        ({"facing": "south", "shape": "straight"},
         {"model": "alekiships:block/watercraft_frame_angled/straight"}),
        ({"facing": "west", "shape": "straight"},
         {"model": "alekiships:block/watercraft_frame_angled/straight", "y": 90}),
        ({"facing": "north", "shape": "inner_left"},
         {"model": "alekiships:block/watercraft_frame_angled/inner", "y": 90}),
        ({"facing": "east", "shape": "inner_left"},
         {"model": "alekiships:block/watercraft_frame_angled/inner", "y": 180}),
        ({"facing": "south", "shape": "inner_left"},
         {"model": "alekiships:block/watercraft_frame_angled/inner", "y": 270}),
        ({"facing": "west", "shape": "inner_left"},
         {"model": "alekiships:block/watercraft_frame_angled/inner"}),
        ({"facing": "north", "shape": "outer_left"},
        ...
        ({"facing": "east", "shape": "outer_left"},
         {"model": "alekiships:block/watercraft_frame_angled/outer"}),
        ({"facing": "south", "shape": "outer_left"},
         {"model": "alekiships:block/watercraft_frame_angled/outer", "y": 90}),
        ({"facing": "west", "shape": "outer_left"},
         {"model": "alekiships:block/watercraft_frame_angled/outer", "y": 180}),
        ({"facing": "north", "shape": "inner_right"},
         {"model": "alekiships:block/watercraft_frame_angled/inner", "y": 180}),
        ({"facing": "east", "shape": "inner_right"},
         {"model": "alekiships:block/watercraft_frame_angled/inner", "y": 270}),
    ...
    for template, processedStates in plankTemplateStates.items():
        ...
        json += [
            ({"facing": "north", "shape": "straight", "frame_processed": processedStates},
             {"model": f"alekiships:block/wood/watercraft_frame_angled/{wood}/straight/{template}",
              "uvlock": True,
              "y": 180}),
            ...
            for template, processedStates in plankTemplateStates.items():
                json += [
                    ({"facing": "north", "shape": f"{shape}_{side}", "frame_processed": processedStates},
                     {"model": f"alekiships:block/wood/watercraft_frame_angled/{wood}/{shape}/{template}",
                      "uvlock": True,
                      "y": rotation[0]}),
