...
public class KayakRenderer extends EntityRenderer<KayakEntity> {
    ...
    private static final ResourceLocation KAYAK =
            new ResourceLocation(AlekiShips.MOD_ID, "textures/entity/watercraft/kayak.png");
    ...
    public KayakRenderer(EntityRendererProvider.Context pContext) {
        ...
        this.kayakResources = Pair.of(new ResourceLocation(AlekiShips.MOD_ID, "textures/entity/watercraft/kayak.png"),
    ...
    public ResourceLocation getTextureLocation(KayakEntity pEntity) {
        return new ResourceLocation(AlekiShips.MOD_ID, "textures/entity/watercraft/kayak.png");
    }
