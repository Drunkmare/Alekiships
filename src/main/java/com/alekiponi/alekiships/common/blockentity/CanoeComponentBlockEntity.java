...
import static com.alekiponi.alekiships.common.block.CanoeComponentBlock.CANOE_CARVED;
...
public class CanoeComponentBlockEntity extends TFCBlockEntity {
    ...
    public CanoeComponentBlockEntity(BlockPos pPos, BlockState pBlockState) {
        super(AlekiShipsBlockEntities.CANOE_COMPONENT_BLOCK_ENTITY.get(), pPos, pBlockState);
    }
