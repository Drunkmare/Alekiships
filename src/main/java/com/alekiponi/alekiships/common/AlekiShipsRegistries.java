...
public class AlekiShipsRegistries {
    ...
    public static final ResourceKey<Registry<BlockEntityIngredientSerializer<?>>> BLOCK_ENTITY_RESULT_SERIALIZER = createRegistryKey(
            "block_entity_result_serializer");
    ...
    public static final ResourceKey<Registry<ConstructionSloopVariant>> CONSTRUCTION_SLOOP_VARIANT = createRegistryKey(
            "construction_variant/sloop");
